window._ssp_global = window._ssp_global || {},
			...
			var i = {
				...
				setPath: function(t, e) {
					...
					if ("object" != typeof t) {
						...
						for (var s in t) s && t.hasOwnProperty(s) && this.setPath(s, t[s])
				},
				...
				create: function(t, e, i, n, o, r) {
					...
					var a = new t.__constructor(e, i, n, o, r);
					return a
				},
				using: function(t) {
					var e = this.find(t);
				...
				define: function(t) {
					...
					t.__name = e, t.__namespace = i, t.__full = i.length > 1 ? i + "." + e : e, t.__deps = t.deps, t.__oojs = this, t.__constructor = function(t, e, i, n, o) {
						if (this.__clones && this.__clones.length > 0)
							for (var r = 0, a = this.__clones.length; a > r; r++) {
								var s = this.__clones[r];
								this[s] = this.__oojs.deepClone(this[s])
							}
					...
					for (var n, o = !1, r = !1, a = i.split("."), s = a.length, d = this.classes, l = 0; s > l; l++) n = a[l], n && (d[n] = d[n] || {}, d = d[n]);
					d[e] = d[e] || {};
					var c = d;
	...
	function(t) {
		...
		t.setPath("http://dup.baidustatic.com/"), t.define({
			name: "static",
			namespace: "http://cpro.baidustatic.com/cpro/ui/dup.ui.assertion.dan",
			deps: {},
			painterName: "static",
			assert: function(t) {
				var e = t.pdb_deliv,
			...
			REQUEST_URL: "http://pos.baidu.com/",
			POS_URL: !1,
			...
			STATUS_FINISH: 16,
			$config: function() {
				i && (this.DUP_PREFIX = i), n && (this.LOADER_DEFINE_NAME = n), this.POS_URL || this.shieldPath()
			},
			shieldPath: function() {
				var t = this.getWord();
				this.POS_URL = this.REQUEST_URL + t[0] + "c" + t[1] + "m?"
			},
			getWord: function() {
				var t, e = Math.random().toString(36).substr(2, 2),
					i = /^[a-z]+$/g;
				return i.test(e) ? t = e.split("") : this.getWord()
			}
		}), t.define({
			name: "lang",
			...
			namespace: "dup.common.utility",
			deps: {
				lang: "http://cpro.baidustatic.com/cpro/ui/dup.common.utility.lang"
			},
			$browser: function() {
			...
			md5: function(t) {
				...
				function i(t, e) {
					var i, n, o, r, a;
					return o = 2147483648 & t, r = 2147483648 & e, i = 1073741824 & t, n = 1073741824 & e, a = (1073741823 & t) + (1073741823 & e), i & n ? 2147483648 ^ a ^ o ^ r : i | n ? 1073741824 & a ? 3221225472 ^ a ^ o ^ r : 1073741824 ^ a ^ o ^ r : a ^ o ^ r
				}
				...
				function s(t, o, r, a, s, d, l) {
					return t = i(t, i(i(n(o, r, a), s), l)), i(e(t, d), o)
				}

				function d(t, n, r, a, s, d, l) {
					return t = i(t, i(i(o(n, r, a), s), l)), i(e(t, d), n)
				}

				function l(t, n, o, a, s, d, l) {
					return t = i(t, i(i(r(n, o, a), s), l)), i(e(t, d), n)
				}

				function c(t, n, o, r, s, d, l) {
					return t = i(t, i(i(a(n, o, r), s), l)), i(e(t, d), n)
				}

				function h(t) {
					for (var e, i = t.length, n = i + 8, o = (n - n % 64) / 64, r = 16 * (o + 1), a = Array(r - 1), s = 0, d = 0; i > d;) e = (d - d % 4) / 4, s = d % 4 * 8, a[e] = a[e] | t.charCodeAt(d) << s, d++;
					return e = (d - d % 4) / 4, s = d % 4 * 8, a[e] = a[e] | 128 << s, a[r - 2] = i << 3, a[r - 1] = i >>> 29, a
				}
			...
			load: function(e, i, n) {
				...
				if (!r) {
					...
					a.type = "text/javascript", a.async = !0, a.src = o;
					var s = t.proxy(this, this.onLoadStatusHandler, e, a);
					a.onload = a.onerror = a.onreadystatechange = s;
					var d = document.getElementsByTagName("script")[0];
					d.parentNode.insertBefore(a, d), this.loadingCls[e] = n
				}
			},
			check: function() {
			...
			$material: function() {
				...
				this.materialFactory = {}, this.materialFactory.text = function(e) {
					...
					for (var n = '<div id="bd_ec_clb_asp" style="width:{width:number}px;height:{height:number}px;overflow:hidden;">{html:string}</div><script>(function(){var d = document;function G(id) { return d.getElementById(id); };var container = G("bd_ec_clb_asp");var pages = container.childNodes;var pl = 0;for (var i = 0; i < pages.length; i++) {if (pages[i].nodeType === 1) {pl++;}}var cp = 0;function showPage(pn) { pages[pn].style.display = ""; };function hidePages() {for (var i = 0; i < pl; i++) {pages[i].style.display = "none";}};function roll() {hidePages();showPage(cp);cp == (pages.length - 1) ? cp = 0 : cp++;};var autoRoll;function setRoll() { autoRoll = window.setInterval(function() { roll(); }, {interval:number});};roll();setRoll();container.onmouseover = function() { window.clearInterval(autoRoll); };container.onmouseout = function() {setRoll(); };})();</script>', o = [], r = e.materials, a = 0; a < r.length; a++) {
						var s = r[a];
						"string" != typeof s && (s = t.formatMaterial(s, i, !0)), o.push(s)
					}
			...
			sendLog: function(t) {
				if (t.response) {
					...
					if (n) {
						...
						o.onload = o.onerror = o.onabort = a, o.src = n
					}
				}
			}
		}), t.define({
				...
				var r = t.proxy(this, function() {
						...
						if (t) try {
							if (this.readyFuncArray && this.readyFuncArray.length)
								for (var r = 0, a = this.readyFuncArray.length; a > r; r++) {
			...
			namespace: "dup.common.utility",
			deps: {
				dom: "http://cpro.baidustatic.com/cpro/ui/dup.common.utility.dom",
				lang: "http://cpro.baidustatic.com/cpro/ui/dup.common.utility.lang",
				browser: "dup.common.utility.browser"
			},
			$style: function() {},
			...
			deps: {
				lang: "http://cpro.baidustatic.com/cpro/ui/dup.common.utility.lang",
				data: "http://cpro.baidustatic.com/cpro/ui/dup.common.utility.data"
			},
			...
			saveOrientation: function(t, e, i) {
				...
				var n = i.merge ? this.data.getInfo(this.orientKey) : {},
					...
					a = {};
				for (var s in r) this.hasOwn.call(r, s) && (a[s] = "array" === this.lang.getType(r[s]) ? r[s].slice() : r[s]);
				for (var d = a[t] || [], l = e.length, c = 0; l > c; c++) {
					var h = e[c];
					"string" == typeof h && (h = encodeURIComponent(h), h.length <= 100 && (d[d.length] = h))
				}
				return d.length ? (a[t] = this.lang.unique(d), this.data.putInfo(o, a), !0) : !1
			},
			getOrientationQuery: function(t) {
				...
				for (var r = "", a = i.length, s = 0; a > s && !(r.length + i[s].length >= t); s++) r += (s ? "&" : "") + i[s];
				return r
			},
			...
			deps: {
				...
				url: "http://cpro.baidustatic.com/cpro/ui/dup.common.utility.url",
			...
			validate: function(t, e, i, n, o) {
				var r = !1,
					a = this.getPrevValue(i, o);
				if (!a) return r;
				for (var s = this.parsePreviewData(a), d = 1 === parseInt(s.type, 10), l = n.length > 0 ? !1 : !0, c = n.length > 0 ? !1 : !0, h = 0, u = n.length; u > h; h++) {
					var p = n[h];
					0 === p ? c = !0 : 4 === p || 50 === p ? (c = !0, l = !0) : (1 === p || 2 === p) && (l = !0)
				}
				return !d && l ? r = parseInt(s.imgWidth, 10) === parseInt(t, 10) && parseInt(s.imgHeight, 10) === parseInt(e, 10) : d && c && this.isAvalibleTextSize(t, e) && (r = !0), r
			},
			...
			getPreviewUrl: function(t, e, i, n) {
				...
				var r = n.indexOf("inlay") >= 0 ? "bd_cpro_prev" : "bd_cpro_fprev",
					a = this.getPrevValue(n, o),
					s = this.parsePreviewData(a),
					d = "";
				return n.indexOf("inlay") >= 0 ? d = this.getInlayUrl(parseInt(s.type, 10), r, a, "text_default_" + t + "_" + e) : n.indexOf("float") >= 0 && (d = this.getFloatUrl(parseInt(s.type, 10), r, a)), d
			},
			getPrevValue: function(t, e) {
				...
				return i.indexOf(r) > -1 && (a = this.url.getQueryValue(i, r)), !a && n && -1 !== n.indexOf(r) && (a = this.cookie.get(r)), a || -1 === o.indexOf(r) || (a = this.url.getQueryValue(o, r)), a
			},
			...
			getFloatUrl: function(t, e, i) {
				var n;
				n = 2 === t ? "http://cpro.baidustatic.com/cpro/ui/float_image.html" : 4 === t || 3 === t ? "http://cpro.baidustatic.com/cpro/ui/float_flash.html" : "http://cpro.baidustatic.com/cpro/ui/blank_tips.html";
			...
			getInlayUrl: function(t, e, i, n) {
				var o;
				o = 1 === t ? n + ".html" : 2 === t ? "http://cpro.baidustatic.com/cpro/ui/image.html" : 4 === t || 3 === t ? "http://cpro.baidustatic.com/cpro/ui/flash.html" : "http://cpro.baidustatic.com/cpro/ui/blank_tips.html";
			...
			getSlotType: function(t) {
				...
				if ((this.inlayFixAssert.assert(i) || this.dynamicFloatAssert.assert(i)) && (e = this.TYPE.INLAY), n && n.fillstyle)
					for (var o = i.placement.fillstyle.elements || [], r = 0, a = o.length; a > r; r++)
			...
			onPostMessageHandler: function(e) {
				if ("object" == typeof e && e.data) {
					...
					if (!(i.indexOf(this.expansionActionName) < 0)) {
						...
						var r = ['<iframe id="{lpIframeId}" ', 'src="{clickUrl}" width="{iframeWidth}" ', 'height="{iframeHeight}" align="center,center" ', 'marginwidth="0"  marginheight="0" ', 'frameborder="0"></iframe>', '<div id="{lpIframeId}_closeBtn" ', 'style="position:absolute;right:0;top:0;', "width:{closeBtnSize}px;", "height:{closeBtnSize}px;", "overflow:hidden;display:block;", "background:url('xuantingClose.png'/*tpa=http://cpro.baidustatic.com/cpro/ui/noexpire/img/2.0.0/xuantingClose.png*/) ", "no-repeat 0 0; ", "_filter:progid:DXImageTransform", ".Microsoft.AlphaImageLoader(", "enabled=true, sizingMethod=none, ", "src='xuantingClose.png'/*tpa=http://cpro.baidustatic.com/cpro/ui/noexpire/img/2.0.0/xuantingClose.png*/);", "_background:none;cursor:pointer;", 'background-position:center;background-size:100%,100%;">&nbsp;</div>'].join(""),
						...
						this.expandContainerEl.innerHTML = this.lang.template(r, s), this.expandContainerEl.style.top = "0", document.body.appendChild(this.expandContainerEl), this.dom.bind(window, "resize", t.proxy(this, this.onResizeHandler));
			...
			monitorLog: function(t) {
				...
				e = "http://cbjslog.baidu.com/log?" + ["type=" + o, "id=" + i, "error=" + t.error, "status=" + t.status, "async=" + n, "from=ssp", "tm=" + +new Date].join("&"), this.sendLogRequest(e)
			},
			...
			getPainter: function(e) {
				...
				for (var n = e.response, o = ["dan.static", "dan.couplet", "dan.expand", "dan.barrier", "dan.video", "topSearchBar", "bottomSearchBar", "slide", "inlayFix", "baiduRec", "dynamicFloat", "float", "insideText", "mobile.inlayFix", "mobile.float"], r = 0, a = o.length; a > r; r++) {
					var s = t.using("dup.ui.assertion." + o[r]);
					if (s && s.assert(n)) return "dup.ui.painter." + o[r]
				}
			...
			deps: {
				...
				style: "dup.common.utility.style",
				dom: "http://cpro.baidustatic.com/cpro/ui/dup.common.utility.dom",
				md5: "http://cpro.baidustatic.com/cpro/ui/dup.common.utility.md5",
				preview: "dup.business.preview",
			...
			snap: function(t) {
				for (var e = [], i = t.paramsList, n = 0, o = i.length; o > n; n++) {
					var r = i[n],
						...
						d = r.value;
					try {
						d = "function" == typeof d ? d.apply(t) : d, d = s ? encodeURIComponent(d) : d, e.push({
							key: a,
							value: d
						})
					} catch (l) {
						var c = "http://cbjslog.baidu.com/log?";
						c += "type=adcodex_error", c += "&info=" + encodeURIComponent(l.message), c += "&stack=" + encodeURIComponent(l.stack || ""), c += "&key=" + encodeURIComponent(a), c += "&t=" + +new Date, (new Image).src = c
					}
				}
				return e
			},
			processExtendsParam: function(t) {
				...
				if (s) {
					a = {};
					for (var d = s.split("&"), l = 0, c = d.length; c > l; l++) {
						var h = d[l].split("=");
						a[h[0]] = h[1]
					}
				}
				if (a && a.hasOwnProperty("cbcw") && a.hasOwnProperty("cbch")) {
					var u = parseInt(a.cbcw || 0, 10),
						p = parseInt(a.cbch || 0, 10),
						m = parseInt(a.cbsz || 0, 10);
			...
			getPmpRequestUrl: function(t) {
				...
				if (l) {
					...
					i.push("dc=2"), r && a > 0 && (e.tt = a + "." + (s - a) + "." + (d - a) + "." + (+new Date - a)), e.exps && (i.push("exps=" + e.exps), e.exps = "")
				} else e.dcf = 1, r && a > 0 && (e.tt = a + ".0.0." + (+new Date - a), e.feid = "7401");
				var w = i.join("&");
			...
			deps: {
				...
				dom: "http://cpro.baidustatic.com/cpro/ui/dup.common.utility.dom",
				log: "http://cpro.baidustatic.com/cpro/ui/dup.common.utility.log",
				lang: "http://cpro.baidustatic.com/cpro/ui/dup.common.utility.lang",
				storage: "dup.common.utility.storage",
				origentation: "dup.business.origentation"
			},
			...
			processSlot: function(t) {
				...
				if (t.response) {
					var n = t.response.rtb_deliv,
						...
						a = parseInt(n.demand_id, 10),
						s = parseInt(o.deliv_id, 10),
			...
			antiShield: function(t) {
				var e = 3e3,
					i = this;
				setTimeout(function() {
					var e = i.dom.g(t.iframeId),
						n = i.dom.g(t.containerId);
					n || i.log.monitorLog({
						type: "shield",
						id: t.id,
						async: t.isAsync,
						error: "containter_delete",
						status: t.status
					}), n && !e && i.log.monitorLog({
						type: "shield",
						id: t.id,
						async: t.isAsync,
						error: "iframe_delete",
			...
			requestSlotInfo: function(t) {
				t.paramObj = this.param.getParamObj(t), t.paramObj.exps = this.config.EXP_ID;
			...
			adInfoIsAvailable: function(t) {
				...
				return 0 === i.deliv_id && 0 === n.deliv_id && 0 === o.deliv_id && 7 == a ? (this.log.monitorLog({
					error: "responseEmpty",
					status: "renderFail"
				}), !1) : !0
			}
			...
			deps: {
				config: "dup.common.config",
				log: "http://cpro.baidustatic.com/cpro/ui/dup.common.utility.log",
				slot: "http://cpro.baidustatic.com/cpro/ui/dup.business.slot"
			},
			$detect: function() {},
			sendLog: function(t) {
			...
			analysisUrl: "a.js" /*tpa=http://eclick.baidu.com/a.js*/ ,
			maxTime: 72e5,
			STATUS: {
				WAIT: 0,
				LOAD: 1,
			...
			computeViewStatus: function(t) {
				...
				if (this.winFocused) try {
					...
					var c = s.top > 0 ? s.top : 0,
						h = s.bottom > a ? a : s.bottom,
						u = s.left > 0 ? s.left : 0,
				...
				try {
					...
					if (t) {
						var o, r = 200,
							a = (new Date).getTime();
						if (this.browser.ie)
							for (o = a + r; o > a;) a = (new Date).getTime();
						else {
							for (var i = 1e5, e = 0; i > e; e++);
							o = (new Date).getTime(), i = 1e5 * r / (o - a), i = i > 1e7 ? 1e7 : i;
							for (var e = 0; i > e; e++);
						}
					}
				} catch (s) {}
				...
				for (var t, e = 0, i = this.delieveryObjArray.length; i > e; e++) {
					...
					if (n.hasOwnProperty("id")) {
						...
						if (n.hasOwnProperty("isAsync") && n.isAsync ? o = n.isAsync : n.hasOwnProperty("async") && n.async && (o = n.async), t = this.slot.createSlot({
							...
							if (a && a.indexOf(":") > -1) {
								r = a.split(":");
								var s = this.param.translateScaleToPixelSize(parseInt(r[0] || 0, 10), parseInt(r[1] || 0, 10));
			...
			registerScrollSubject: function(t, e, i, n, o, r, a) {
				if (!this.scrollObserver[t][e]) {
					...
					s.isExpand = !0, s.origin = i, s.originWidth = n, s.originHeight = o, s.targetWidth = r, s.targetHeight = a
				}
			},
			...
			expand2Left: function(t, e, i, n, o, r) {
				...
				a.style.bottom = 0, a.style.right = s - i + "px"
			},
			...
			expandAd: function(t) {
				if (!this.expandStatus[t]) {
					...
					if (1 === c || 2 === c ? (p.setAttribute("height", s), p.style.height = s + "px") : (3 === c || 4 === c) && (p.setAttribute("width", a), p.style.width = a + "px"), 2 == l && 2 == c || 2 == l && 4 == c) switch (c) {
						case 2:
							p.setAttribute("height", s), p.style.height = s + "px";
							break;
						case 4:
							p.setAttribute("width", a), p.style.width = a + "px"
			...
			collapseAd: function(t) {
				if (this.expandStatus[t]) {
					...
					a.style.position = "", a.style.width = "", a.style.height = "", a.style.top = "", a.style.left = "", s.style.position = "", s.style.display = "", s.style.top = "", s.style.left = "", s.style.right = "", s.style.width = "", s.style.height = "", s.setAttribute("height", o), s.setAttribute("width", n);
					for (var d in this.scrollObserver)
						for (var l in this.scrollObserver[d]) l == t && (this.scrollObserver[d][l].isExpand = !1)
				}
			},
			observer: function(t) {
			...
			cacheRequestCallback: function(e) {
				...
				if ("success" !== i) {
					...
					var r = n.response,
						...
						s = r.rtb_deliv,
						d = r.order_deliv;
					if (0 === a.deliv_id && (0 !== parseInt(d.deliv_id, 10) || 0 !== parseInt(s.deliv_id, 10)) && "success" !== i && 7 === r.placement.complement_type) {
			...
			renderFrame: function(t, e) {
				...
				if (i && !this.slot.checkStatus(i, this.config.STATUS_FINISH)) {
					...
					try {
						...
						a.open("text/html", "replace"), a.write(r), a.close(), a.body && (a.body.style.backgroundColor = "transparent")
					} catch (s) {
						this.log.monitorLog({
							id: t,
							error: "frameFail",
			...
			getFrameUrl: function() {
				return this.requireDomainPolicy() ? this.data.getConfig("domainPolicyFileUrl") || "http://cpro.baidustatic.com/domain-policy.htm" : this.requireBlankPolicy() ? this.data.getConfig("blankPolicyFileUrl") || "http://cpro.baidustatic.com/blank-policy.htm" : "about:blank"
			},
			...
			processFrameData: function(e) {
				var i, n, o = "",
					r = [];
				if (e.response) {
					var a = e.response.placement;
					n = a.container;
					try {
						r = a.fillstyle.elements || []
					} catch (s) {}
				}
		    ...
		    name: "floatBlock", namespace: "dup.ui.painter", deps: { config: "dup.common.config", style: "dup.common.utility.style", log: "http://cpro.baidustatic.com/cpro/ui/dup.common.utility.log", dom: "http://cpro.baidustatic.com/cpro/ui/dup.common.utility.dom", lang: "http://cpro.baidustatic.com/cpro/ui/dup.common.utility.lang", cookie: "dup.common.utility.cookie", unicode: "dup.common.utility.unicode", frame: "dup.business.frame", slot: "http://cpro.baidustatic.com/cpro/ui/dup.business.slot", deliveryLimit: "dup.business.deliveryLimit" }, GAP: 5, NORMAL_CLOSE_BTN_HEIGHT: 17, COUPLET_CLOSE_BTN_HEIGHT: 20, validate: function (t) { if ("union" === t.productLine) { var e = this.deliveryLimit.TYPE.POPUP; ("couplet" === t.blockType || "button" === t.blockType) && (e = this.deliveryLimit.TYPE.COUPLET); var i = this.validateLimit(e); if (!i) return !1; this.deliveryLimit.setAdsCount(e, t.domId) } var n = this.getCloseCookieName(t); return 2 === t.closeType && this.cookie.get(n) ? !1 : !0 }, validateLimit: function (t) { var e = this.deliveryLimit.getAdCount(t), i = this.deliveryLimit.MAX_COUNT[t]; return i > e ? !0 : void 0 }, createBlockHtmlTemplate: function (t) { var e = ["{iframe}", "{closeBtn}"].join(""); if (!t.blockType || "default" === t.blockType) return e; var i = ["box-sizing: content-box;", "width:{width}px;", "height:{height}px;", "padding:4px;", "border:#acacac 1px solid;", "overflow:hidden;"]; return ("button" === t.blockType || "popup" === t.blockType) && i.push("position:absolute;left:0;top:" + (this.COUPLET_CLOSE_BTN_HEIGHT + this.GAP) + "px;"), e = ['<div style="' + i.join("") + '">', "{iframe}", "</div>", "{closeBtn}"].join("") }, createCloseElement: function (t) { var e = {}, i = "\\u5FAE\\u8F6F\\u96C5\\u9ED1", n = "\\u5173\\u95ED", o = t.domId + "_closebtn", r = this; return e.couplet = function () { var e = ["box-sizing: content-box;", "position:absolute;", "width:" + t.containerWidth + "px;", "height:20px;", "top:" + (t.containerHeight - this.COUPLET_CLOSE_BTN_HEIGHT) + "px;", "left:0;", "cursor:pointer;", "background-color:#999999;", "color:#fff;font-size:12px;", "font-family: " + r.unicode.toDecode(i) + ";", "text-align:center;line-height:20px;"].join(""), a = '<div id="' + o + '" style="' + e + '">' + r.unicode.toDecode(n) + "</div>"; return a }, e.button = e.popup = function () { var e = 61, i = t.containerWidth - e, n = "\\u5FAE\\u8F6F\\u96C5\\u9ED1", a = "\\u5173\\u95ED", s = ["box-sizing: content-box;", "position:absolute;width:" + e + "px;", "height:20px;top:0;", "left:" + i + "px;", "margin:0;padding:0;margin-bottom:5px;", "cursor:pointer;overflow:hidden;"].join(""), d = ['<div id="' + o + '" style="' + s + '">', '<div style="', "box-sizing: content-box;", "width:40px;height:20px;", "background-color:#999999;", "color:#fff;float:left;", "margin-right:1px;font-size:12px;", "font-family:" + r.unicode.toDecode(n) + ";", "text-align: center;line-height:20px;", '">' + r.unicode.toDecode(a) + "</div>", '<a style="maring:0;padding:0;', "display:inline-block;border:none;", "overflow:hidden;height:20px;", "line-height:20px;cursor:pointer;", "width:20px;background:url(", "'http://cpro.baidustatic.com/cpro/ui/", "noexpire/img/2.0.1/xuanfu_close.png", "') no-repeat 0 0;margin-bottom:3px;", 'float:left" ></a>', "</div>"].join(""); return d }, e["default"] = function () { var e = "close.gif"/*tpa=http://cpro.baidustatic.com/cpro/ui/noexpire/img/clb/1.0.0/close.gif*/, i = ["box-sizing: content-box;", "height:15px;", "border:1px solid #e1e1e1;", "background:#f0f0f0;", "margin:0;", "padding:0;", "overflow:hidden;"].join(""), n = ["box-sizing: content-box;", "float:right;", "clear:right;", "margin:2px 5px 0 0;", "width:39px;", "height:13px;", "cursor:pointer;", "background:url(" + e + ") no-repeat scroll 0 0;"].join(""), o = ['<div style="' + i + '">', '<span id="' + t.domId + '_closebtn" style="' + n + '" ', "onmouseover=\"this.style.backgroundPosition='0 -20px';\" ", "onmouseout=\"this.style.backgroundPosition='0 0';\" ", ">", "</span>", "</div>"].join(""); return o }, e[t.blockType]() }, getVerticalStyle: function (t) { var e = t.vSpace || 10; "center" === t.verticalType && (e = .5 * (this.style.getClientHeight() - t.containerHeight)); var i = t.verticalType; return i && "center" !== i || (i = "top"), { cssName: i, cssValue: e } }, getHorizontalStyle: function (t) { var e = t.hSpace || 10; if (t.contentWidth > 0 && 1 === t.dockType) { var i = Math.floor(.5 * (this.style.getClientWidth() - t.contentWidth)); i >= t.width && (e = "right" === t.horizontalType ? i - t.containerWidth - e : i - t.containerWidth - e) } else "center" === t.horizontalType && (e = .5 * (this.style.getClientWidth() - t.containerWidth)); var n = t.horizontalType; return n && "center" !== n || (n = "left"), { cssName: n, cssValue: e } }, createContainerElementByInfo: function (t) {
		        var e = null; this.dom.g(t.domId) ? e = this.dom.g(t.domId) : (e = document.createElement("div"), e.id = t.domId); var i = ["box-sizing: content-box;", "width: " + t.containerWidth + "px;", "height: " + t.containerHeight + "px;", "overflow: hidden;", "z-index: 2147483647;"]; if (1 === t.followType) if (this.style.canFixed()) { i.push("position: fixed;"); var n = this.getVerticalStyle(t), o = this.getHorizontalStyle(t); i.push(n.cssName + ":" + n.cssValue + "px;"), i.push(o.cssName + ":" + o.cssValue + "px;") } else { i.push("position: absolute;"), this.updatePosition(t, e); var r = this; this.dom.bind(window, "scroll", function () { r.updatePosition(t, t.domId) }), this.dom.bind(window, "resize", function () { r.updatePosition(t, t.domId) }) } else { i.push("position: absolute;"); var n = this.getVerticalStyle(t), o = this.getHorizontalStyle(t); i.push(n.cssName + ":" + n.cssValue + "px;"), i.push(o.cssName + ":" + o.cssValue + "px;") } return e.style.cssText = i.join(""), e;
						...
						if (i) {
							...
							"top" === t.verticalType || 0 === t.verticalType.length ? n.top = l + t.vSpace + "px" : n.top = l + s - t.vSpace - t.containerHeight + "px";
							var h = Math.floor(.5 * (this.style.getClientWidth() - t.contentWidth));
							"left" === t.horizontalType || 0 === t.horizontalType ? c ? n.left = d + h - t.hSpace - t.containerWidth + "px" : n.left = d + t.hSpace + "px" : c ? n.left = d + h + t.contentWidth + t.hSpace + "px" : n.left = d + a - t.hSpace - t.containerWidth + "px"
						}
						...
						if (this.validate(e)) {
							...
							a.innerHTML = this.lang.template(o, r), this.dom.g(e.domId) || document.body.insertBefore(a, document.body.firstChild), this.registEvent(e);
							var s = e.closeTime || 0;
							s > 0 && setTimeout(t.proxy(this, this.autoClose), 1e3 * s), i.isPdbAd || this.slot.setStatus(i.id, this.config.STATUS_FINISH)
						}
					}
				}), t.define({
				name: "inlayFix",
				...
				processSlotInfo: function(t) {
					...
					if (1 === o) e.width = r, e.height = a;
					else if (2 === o || 5 === o) {
						e.wScale = r, e.hScale = a;
						var l = 0,
							c = t.styleOpenApi.cpro_ftpc || "true" === t.styleOpenApi.cpro_ftpc ? !0 : !1;
						c = 5 === o ? !0 : c;
						var h = this.dom.g(t.containerId);
						c && h && h.parentElement.clientWidth && (l = h.parentElement.clientWidth || 0);
						...
						n.width = t.width = e.width = p, n.height = t.height = e.height = a
					}
					e.sizeType = o;
					var m = t.styleOpenApi,
						f = m.cpro_w || m.rsi0 || 0,
						g = m.cpro_h || m.rsi1 || 0;
					return (f || g) && (e.width = f || this.getCurViewportWidth(r), e.height = g || a, t.width = e.width, t.height = e.height), e
				},
				...
				processSlotInfo: function(t) {
					...
					a.backgroundOpacity = o, a.backgroundColor = r;
					var s = i.location;
					return 2 !== s && 3 !== s && (s = 3), a.locationType = s, a.containerId = t.containerId, a.closeType = i.closeType, a
				},
				parseHtmlSnippet: function(t) {
					...
					if (this.validate(i)) {
						...
						if (!n) {
							...
							if (o) {
								...
								if (2 === i.sizeType) {
									var a = e.response.pdb_deliv.deliv_des;
									if (a && a._html) {
										a = a._html;
										var s = a.type;
										("text" === s || "image" === s || "flash" === s) && (a.width = e.width, a.height = e.height)
									}
								}
								var d = {
										id: e.id,
				...
				processSlotInfo: function(t) {
					...
					0 === s && "button" === g ? (v = "bottom", s = 40) : 0 === s && "couplet" === g && (v = "top", s = 150);
					...
					if (this.validate(e)) {
						...
						if (!i) {
							...
							var o = e.response.placement,
								r = o.container,
								a = parseInt(r.location || 0, 10);
							if (6 === a) {
								var s = this.slot.cloneSlot(e);
								s.response.placement.container.location = 5, s.containerId = s.containerId + "_right", this.slot.addSlot(s), n.push(s), e.response.placement.container.location = 4, e.containerId = e.containerId + "_left"
							}
				...
				process: function() {
					this.prepareApi(), r && this.unionDelivery.launch(), a && this.dupDelivery.launch(), o && this.clbDelivery.launch(), s && this.standardDelivery.launch(), this.fingerPrint.start()
				},
				prepareApi: function() {
			...
			var d = t.using("http://cpro.baidustatic.com/cpro/ui/dup.ui.delivery.main"); 
		}(_ssp_global.oojs);